<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="OnlineUsersStats.aspx.cs" Inherits="AspNetDating.Admin.OnlineUsersStats" %>
...
<div class="panel panel-filter">
    ...
    <div id="pnlOnlineUsersChart" runat="server">
        <asp:Chart ID="ChartOnlineUsers" runat="server" Width="600" Height="200" Palette="BrightPastel" BackColor="#D3DFF0" BorderDashStyle="Solid" BackGradientStyle="TopBottom" BorderWidth="2" BorderColor="26, 59, 105">
            <Titles>
    ...
    <asp:DataGrid CssClass="table table-striped"  ID="dgOnlineUsers" runat="server" AllowPaging="False" AutoGenerateColumns="False" AllowSorting="True" GridLines="None">
