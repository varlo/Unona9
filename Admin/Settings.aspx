<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="Settings.aspx.cs" Inherits="AspNetDating.Admin.Settings" %>
...
<div class="panel clear-panel">
    <div class="panel-heading"><h4 class="panel-title"> <%= Lang.TransA("Change Your Password") %></h4></div>
    <div class="panel-body">
        <div class="form-horizontal medium-width">
            ...
            <div class="form-group">
                <label class="control-label col-sm-4"><%= Lang.TransA("New password") %></label>
                <div class="col-sm-8"><asp:TextBox CssClass="form-control" ID="txtNewPassword" Runat="server" TextMode="Password"/></div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-4"><%= Lang.TransA("Confirm new password") %></label>
