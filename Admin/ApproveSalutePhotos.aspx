<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="ApproveSalutePhotos.aspx.cs" Inherits="AspNetDating.Admin.ApproveSalutePhotos" %>
	        ...
	        <div class="panel default-panel medium-width center-block">
                ...
                <div class="panel-body">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><%= Lang.TransA("Reason to delete") %></span>
...
<asp:UpdatePanel ID="UpdatePanelPhoto" runat="server">
    <ContentTemplate>
        ...
        <asp:DataList CssClass="table table-striped" ID="listPendingApproval" runat="server" OnItemCommand="listPendingApproval_ItemCommand" RepeatLayout="Table" RepeatDirection="Horizontal">
            <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center"></ItemStyle>
            <ItemTemplate>
                <asp:LinkButton ID="lnkApprovePhoto" CommandArgument='<%# Eval("PhotoID")%>' runat="server">
                <img class="img-thumbnail" src="<%= Config.Urls.Home%>/Image.ashx?id=<%# Eval("PhotoID")%>&width=100&height=100&cache=1"></asp:LinkButton>
            </ItemTemplate>
        </asp:DataList>
        </div>
        <div class="actions">
