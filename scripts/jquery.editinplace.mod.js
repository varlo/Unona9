...
(function ($) {
    ...
    $.fn.editInPlace = function (options) {
        ...
        return this.each(function () {
            ...
            if (dom.parent().data('editInPlace'))
                return; // already an editor here
            dom.parent().data('editInPlace', true);
    ...
    $.fn.editInPlace.defaults = {
        ...
        dynamic_params: function (dom) { return ""; }, //function that returns additional query paramaters for each dom element. "dom" argument is jquery object of the dom element
        validate_input: function (dom, newValue) { return true; },
    ...
    $.extend(InlineEditor.prototype, {
        ...
        disconnectOpeningEvents: function () {
            ...
            this.dom.parent().unbind('.editInPlace');
        },
        ...
        addHoverEffect: function () {
            if (this.settings.hover_class)
                ...
                this.dom.parent().css("background-color", this.settings.bg_over);
        },
        ...
        removeHoverEffect: function () {
            if (this.settings.hover_class)
                ...
                this.dom.parent().css("background-color", this.settings.bg_out);
        },
        ...
        replaceContentWithEditor: function () {
            ...
            this.dom.html('<div class="inplace_form"></div>')
			.find('.inplace_form')
        ...
        connectClosingEventsToEditor: function () {
            ...
            var form = this.dom.find(".inplace_form");
        ...
        handleSubmitToCallback: function (enteredText) {
			...
			this.settings.params, this.settings.dynamic_params(this.dom), this.savingAnimationCallbacks());
        ...
        handleSubmitToServer: function (enteredText) {
            if (enteredText !== '' && this.settings.validate_input(this.dom, enteredText) === false) {
                this.handleCancelEditor();
                return;
            }
            var dynamicParams = this.settings.dynamic_params(this.dom);
            ...
            $.ajax({
                ...
                success: function (html) {
                    ...
                    that.setDefaultTextIfNeccessary();
