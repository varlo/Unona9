    ...
    $.jPicker =
    {
        ...
        if (init) {
            if (init.ahex != null) val('ahex', init);
                ...
                if (init.hex.length == 3 && init.hex.charAt(0) == init.hex.charAt(1) && init.hex.charAt(0) == init.hex.charAt(2))
                    init.hex = init.hex + init.hex;
    ...
    ColorMethods: // color conversion methods  - make public to give use to external scripts
        ...
        hexToRgba:
            function (hex) {
                ...
                if (hex.length == 3 && hex.charAt(0) == hex.charAt(1) && hex.charAt(0) == hex.charAt(2))
                    hex = hex + hex;
