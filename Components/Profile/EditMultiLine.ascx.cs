...
{
    public partial class EditMultiLine : UserControl, IProfileQuestionComponent, ICascadeQuestionComponent
    {
        ...
        private User user;
        protected HtmlGenericControl tdUser;
        ...
        {
            txtCharCount.Text = txtValue.Text.Length.ToString();
            txtValue.Attributes.Add("onkeydown", String.Format("textCounter('{0}', '{1}')",
                txtValue.ClientID, txtCharCount.ClientID));
            txtValue.Attributes.Add("onkeyup", String.Format("textCounter('{0}','{1}')", 
                txtValue.ClientID, txtCharCount.ClientID));
            base.OnPreRender(e);
        }
        ...
        public void GenerateResetValuesJS()
        {
            ...
            js += "function Reset" + pnlID.ClientID + "()" +
                  ...
                  "$get('" + txtCharCount.ClientID + "').value = 0;}";
            js += "</script>";
