...
{
    public partial class SearchRangeChoiceSelect2 : UserControl, IProfileSearchComponent, ICascadeQuestionComponent
    {
        ...
        public ProfileQuestion Question
        {
            set
            {
                ...
                ltrName.Text = Config.Misc.EnableProfileDataTranslation ? Lang.Trans(value.AltName) : value.AltName;
        ...
        public int[] ChoiceIds
        {
            ...
            set
            {
                ...
                var lChoiceIds = new List<int>(value);
                lChoiceIds.Sort();
